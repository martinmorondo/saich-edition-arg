...
export default function Banner() {
  return (
    <section className="main-banner" id="top" style={{ paddingTop: '150px', paddingBottom: '80px' }}>
      <div className="container">
        <div className="row align-items-center">
          
          <div className="col-lg-6">
            <FadeIn direction="left" delay={0.2} duration={1} className="left-content header-text">
              ...
              {/* Estructura de Botones CTA (Primario y Secundario) */}
          ...
          <div className="col-lg-6 mt-5 mt-lg-0 text-center">
            <FadeIn direction="right" delay={0.5} duration={1} className="right-image">
              {/* Imagen con efecto de flotación infinito */}
              <motion.img 
